...
export const HomePage = () => (
  <div className="space-y-14 pb-14">
    <section className="relative left-1/2 right-1/2 min-h-[calc(100vh-88px)] w-screen -translate-x-1/2 overflow-hidden">
      ...
      <div className="page-shell flex min-h-[calc(100vh-88px)] items-center py-10">
        <div className="grid w-full items-center gap-8 lg:grid-cols-[1.08fr_0.92fr]">
          <div>
            <p className="text-[11px] font-semibold uppercase tracking-[0.34em] text-emerald-100">Saylani Student Portal</p>
            <h1 className="mt-5 max-w-4xl text-4xl font-extrabold leading-[1.04] tracking-tight text-slate-50 sm:text-5xl xl:text-6xl">
              A modern student portal inspired by <span className="gradient-text">Saylani&apos;s mission of learning and opportunity</span>
            </h1>
            <p className="mt-5 max-w-2xl text-base leading-7 text-slate-100/95">
          ...
          <Card className="relative overflow-hidden border-white/20 bg-white/70 p-0 backdrop-blur-md">
            ...
            <div className="grid gap-px bg-slate-900/6 sm:grid-cols-2">
              ...
              <div className="space-y-3 bg-white/28 p-6 sm:p-7">
                {[
                  ...
                  <div className="border border-slate-300/60 bg-white/34 px-4 py-4 text-sm leading-6 text-slate-800" key={item}>{item}</div>
                ))}
              </div>
            </div>
          </Card>
    ...
    <div className="page-shell space-y-14">
      <section className="grid gap-5 md:grid-cols-3">
        {supportPillars.map((pillar) => (
          <Card className="relative overflow-hidden border-white/12 bg-slate-950/38 p-6 backdrop-blur-xl" key={pillar.title}>
      ...
      <section>
        <Card className="relative overflow-hidden border-white/12 bg-slate-950/40 p-6 sm:p-7 backdrop-blur-xl">
          <div className="absolute inset-x-0 top-0 h-px bg-gradient-to-r from-emerald-400/55 via-sky-400/35 to-transparent" />
          <FacebookFeed />
        </Card>
      </section>
      ...
      <section className="grid gap-6 xl:grid-cols-[1fr_1fr]">
        <Card className="relative overflow-hidden border-white/12 bg-slate-950/38 p-6 sm:p-7 backdrop-blur-xl">
          <div className="absolute inset-x-0 top-0 h-px bg-gradient-to-r from-emerald-400/55 via-sky-400/35 to-transparent" />
      ...
      <section className="space-y-5">
        ...
        <div className="grid gap-5 md:grid-cols-3">
          {HOME_UPDATES.map((item) => (
            <Card className="hover-lift relative overflow-hidden border-white/12 bg-slate-950/38 p-6 backdrop-blur-xl" key={item.id}>
              <div className="absolute inset-x-0 top-0 h-px bg-gradient-to-r from-emerald-400/55 via-sky-400/35 to-transparent" />
